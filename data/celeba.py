...
path='/srv/glusterfs/laurenf/IdCycleGAN_FaceTranslation-master/CelebA/Img/img_align_celeba'
...
def load(batch_size, data_dir='/srv/glusterfs/laurenf/IdCycleGAN_FaceTranslation-master/CelebA/128_crop'):
    return (
